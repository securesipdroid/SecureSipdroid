...
import org.sipdroid.sipuas.SipdroidEngine;
...
public class Settings extends PreferenceActivity implements OnSharedPreferenceChangeListener, OnClickListener {
	...
	private final String sharedPrefsPath = "/data/data/org.sipdroid.sipuas/shared_prefs/";
	// Shared preference file name - !!!should be replaced by some system variable!!!
	private final String sharedPrefsFile = "org.sipdroid.sipuas_preferences";
	...
	public static final String PREF_PREFERRED_IFACE = "pref_iface";
	...
	// preferred network interface
	public static final String	DEFAULT_PREFERRED_IFACE = "";
