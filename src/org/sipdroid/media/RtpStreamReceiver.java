...
import org.sipdroid.sipuas.R;
import org.sipdroid.sipuas.UserAgent;
import org.sipdroid.sipuas.ui.InCallScreen;
import org.sipdroid.sipuas.ui.Receiver;
import org.sipdroid.sipuas.ui.Sipdroid;
...
public class RtpStreamReceiver extends Thread {
	...
	public static synchronized void ringback(boolean ringback) {
		if (ringback && ringbackPlayer == null) {
			...
			setMode(speakermode);
			enableBluetooth(PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(org.sipdroid.sipuas.ui.Settings.PREF_BLUETOOTH,
					org.sipdroid.sipuas.ui.Settings.DEFAULT_BLUETOOTH));
			...
			ringbackPlayer = new ToneGenerator(stream(),(int)(ToneGenerator.MAX_VOLUME*2*org.sipdroid.sipuas.ui.Settings.getEarGain()));
	...
	void restoreVolume() {
		...
		case AudioManager.MODE_IN_CALL:
				...
				if (oldring > 0) setStreamVolume(AudioManager.STREAM_RING,(int)(
						...
						org.sipdroid.sipuas.ui.Settings.getEarGain()), 0);
				track.setStereoVolume(AudioTrack.getMaxVolume()*
						org.sipdroid.sipuas.ui.Settings.getEarGain()
	...
	void saveSettings() {
		if (!PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(org.sipdroid.sipuas.ui.Settings.PREF_OLDVALID, org.sipdroid.sipuas.ui.Settings.DEFAULT_OLDVALID)) {
			...
			if (!PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).contains(org.sipdroid.sipuas.ui.Settings.PREF_OLDVIBRATE2))
			...
			Editor edit = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).edit();
			edit.putInt(org.sipdroid.sipuas.ui.Settings.PREF_OLDVIBRATE, oldvibrate);
			edit.putInt(org.sipdroid.sipuas.ui.Settings.PREF_OLDVIBRATE2, oldvibrate2);
			edit.putInt(org.sipdroid.sipuas.ui.Settings.PREF_OLDPOLICY, oldpolicy);
			edit.putInt(org.sipdroid.sipuas.ui.Settings.PREF_OLDRING, am.getStreamVolume(AudioManager.STREAM_RING));
			edit.putBoolean(org.sipdroid.sipuas.ui.Settings.PREF_OLDVALID, true);
			edit.commit();
		}
	}
	...
	public static void setMode(int mode) {
		Editor edit = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).edit();
		edit.putBoolean(org.sipdroid.sipuas.ui.Settings.PREF_SETMODE, true);
		edit.commit();
		AudioManager am = (AudioManager) Receiver.mContext.getSystemService(Context.AUDIO_SERVICE);
		if (Integer.parseInt(Build.VERSION.SDK) >= 5) {
	...
	public static void restoreMode() {
		if (PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(org.sipdroid.sipuas.ui.Settings.PREF_SETMODE, org.sipdroid.sipuas.ui.Settings.DEFAULT_SETMODE)) {
			Editor edit = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).edit();
			edit.putBoolean(org.sipdroid.sipuas.ui.Settings.PREF_SETMODE, false);
			edit.commit();
	...
	public static void restoreSettings() {
		if (PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(org.sipdroid.sipuas.ui.Settings.PREF_OLDVALID, org.sipdroid.sipuas.ui.Settings.DEFAULT_OLDVALID)) {
			...
			int oldvibrate = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getInt(org.sipdroid.sipuas.ui.Settings.PREF_OLDVIBRATE, org.sipdroid.sipuas.ui.Settings.DEFAULT_OLDVIBRATE);
			int oldvibrate2 = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getInt(org.sipdroid.sipuas.ui.Settings.PREF_OLDVIBRATE2, org.sipdroid.sipuas.ui.Settings.DEFAULT_OLDVIBRATE2);
			int oldpolicy = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getInt(org.sipdroid.sipuas.ui.Settings.PREF_OLDPOLICY, org.sipdroid.sipuas.ui.Settings.DEFAULT_OLDPOLICY);
			...
			Editor edit = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).edit();
			edit.putBoolean(org.sipdroid.sipuas.ui.Settings.PREF_OLDVALID, false);
			edit.commit();
	...
	public void run() {
		boolean nodata = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(org.sipdroid.sipuas.ui.Settings.PREF_NODATA, org.sipdroid.sipuas.ui.Settings.DEFAULT_NODATA);
		keepon = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(org.sipdroid.sipuas.ui.Settings.PREF_KEEPON, org.sipdroid.sipuas.ui.Settings.DEFAULT_KEEPON);
		...
		ToneGenerator tg = new ToneGenerator(AudioManager.STREAM_VOICE_CALL,(int)(ToneGenerator.MAX_VOLUME*2*org.sipdroid.sipuas.ui.Settings.getEarGain()));
		track.play();
		System.gc();
		empty();
		lockFirst = true;
